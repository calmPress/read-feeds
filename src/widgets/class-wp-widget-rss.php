...
class WP_Widget_RSS extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'description'                 => __( 'Entries from any RSS or Atom feed.', 'calm_read_feeds' ),
		...
		parent::__construct( 'rss', __( 'RSS', 'calm_read_feeds' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $title ) ) {
			$title = ! empty( $desc ) ? $desc : __( 'Unknown Feed', 'calm_read_feeds' );
		}
		...
		\calmpress\readfeeds\wp_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return \calmpress\readfeeds\wp_widget_rss_process( $new_instance, $testurl );
	}
	...
	public function form( $instance ) {
		...
		\calmpress\readfeeds\wp_widget_rss_form( $instance );
	}
}
